...
func StatusUnavailable(err string) ServiceStatus {
	return ServiceStatus{Status: "unavailable", Error: err}
}
func StatusUnconfigured(err string) ServiceStatus {
	return ServiceStatus{Status: "unconfigured", Error: err}
}
