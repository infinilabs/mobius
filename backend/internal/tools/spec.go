// Agent tool definitions and per-role tool lists (plan 6.4f prep): which
// tools each employee gets, plus hire-duplicate and manager guidance rules.
package tools
...
var DelegateTaskToolDef = llm.ToolDef{
	Name:        "delegate_task",
...
var HireEmployeeToolDef = llm.ToolDef{
	Name:        "hire_employee",
...
var SubmitTaskResultToolDef = llm.ToolDef{
...
var ReviewTaskToolDef = llm.ToolDef{
	Name:        "review_task",
...
var ListTeamToolDef = llm.ToolDef{
	Name:        "list_team",
...
var ForgetMemoryToolDef = llm.ToolDef{
	Name:        "forget_memory",
...
var WriteFileToolDef = llm.ToolDef{
...
var ReadFileToolDef = llm.ToolDef{
...
var SearchAssetsToolDef = llm.ToolDef{
...
var ListAssetsToolDef = llm.ToolDef{
...
var ListTasksToolDef = llm.ToolDef{
	Name:        "list_tasks",
...
var ListProjectsToolDef = llm.ToolDef{
	Name:        "list_projects",
...
var ListEmployeesToolDef = llm.ToolDef{
	Name:        "list_employees",
...
var GetEmployeeToolDef = llm.ToolDef{
	Name:        "get_employee",
...
var UpdateTaskStatusToolDef = llm.ToolDef{
...
var ListPromptsToolDef = llm.ToolDef{
	Name:        "list_prompts",
...
var CreatePromptToolDef = llm.ToolDef{
	Name:        "create_prompt",
...
var UpdatePromptToolDef = llm.ToolDef{
	Name:        "update_prompt",
...
var DeletePromptToolDef = llm.ToolDef{
	Name:        "delete_prompt",
...
var ListSkillsToolDef = llm.ToolDef{
	Name:        "list_skills",
...
var AssignSkillToolDef = llm.ToolDef{
	Name:        "assign_skill",
...
var UnassignSkillToolDef = llm.ToolDef{
	Name:        "unassign_skill",
...
// --- domain.Employee tools ---

var UpdateEmployeeToolDef = llm.ToolDef{
...
var UpdateTaskToolDef = llm.ToolDef{
	Name:        "update_task",
...
var AddTaskCommentToolDef = llm.ToolDef{
...
var GetTaskToolDef = llm.ToolDef{
	Name:        "get_task",
...
var UpdateProjectToolDef = llm.ToolDef{
	Name:        "update_project",
...
var CreateProjectToolDef = llm.ToolDef{
	Name:        "create_project",
...
var RunCommandToolDef = llm.ToolDef{
...
var VerifyDeliverableToolDef = llm.ToolDef{
...
var AskUserToolDef = llm.ToolDef{
	Name:        "ask_user",
...
var SuggestTasksToolDef = llm.ToolDef{
	Name:        "suggest_tasks",
...
var QueryTagsToolDef = llm.ToolDef{
	Name: "query_tags",
...
var WatermarkAssetsToolDef = llm.ToolDef{
...
var VerifyWatermarkToolDef = llm.ToolDef{
...
var PlayableLoadReferenceGameToolDef = llm.ToolDef{
...
var PlayableGetTrackingSDKToolDef = llm.ToolDef{
...
var PlayableGetWebAudioSFXToolDef = llm.ToolDef{
...
var PlayableWriteHTMLToolDef = llm.ToolDef{
...
var GenerateImageToolDef = llm.ToolDef{
	Name:        "generate_image",
...
var GenerateAudioToolDef = llm.ToolDef{
	Name:        "generate_audio",
...
var PublishPlayableAdToolDef = llm.ToolDef{
...
var SaveUploadToAssetsToolDef = llm.ToolDef{
...
func BuildAgentTools(agent *domain.Employee, task *domain.Task) []llm.ToolDef {
	...
	if agent.Role == "CEO" || domain.HasTag(agent.Tags, "manager") || domain.HasTag(agent.Tags, "founder") {
	...
	if agent.Role == "CEO" || domain.HasTag(agent.Tags, "manager") {
		tools = append(tools, DelegateTaskToolDef, ReviewTaskToolDef, VerifyDeliverableToolDef)
	}

	if domain.HasTag(agent.Tags, "manager") {
	...
	if domain.HasTag(agent.Tags, "playable_planner") {
		// Planner tools (if any)
	}
	if domain.HasTag(agent.Tags, "playable_designer") {
		tools = append(tools, GenerateImageToolDef)
	}
	if domain.HasTag(agent.Tags, "playable_developer") {
	...
	if domain.HasTag(agent.Tags, "playable_publisher") {
	...
	if agent.Role == "CEO" || domain.HasTag(agent.Tags, "manager") || domain.HasTag(agent.Tags, "founder") ||
		domain.HasTag(agent.Tags, "playable_planner") || domain.HasTag(agent.Tags, "playable_designer") ||
		domain.HasTag(agent.Tags, "playable_developer") {
...
func CheckHireDuplicate(manager *domain.Employee, newTitle string) (string, bool) {
