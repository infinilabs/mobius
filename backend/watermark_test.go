...
func TestBuildAgentTools_Watermarker(t *testing.T) {
	watermarker := makeEmployee("Custom", []string{"media_watermarker"}, strPtr("mgr-001"), nil)
...
// 3. Mock DB and Task Driver state transitions
...
func (m *mockDBClient) AddTaskComment(ctx context.Context, taskID, authorID, content string) (*TaskComment, error) {
